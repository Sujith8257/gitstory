...
async function generateFavicon() {
  ...
  // Generate additional PNG sizes for PWA
...
function createIco(pngBuffers, sizes) {
  ...
  for (let i = 0; i < numImages; i++) {
    ...
    icoBuffer.writeUInt32LE(pngData.length, offset); offset += 4; // Size of image data
    icoBuffer.writeUInt32LE(dataOffset, offset); offset += 4; // Offset to image data
